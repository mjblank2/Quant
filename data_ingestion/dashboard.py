...
if IS_STREAMLIT:
    ...
    st.dataframe(view_latest_predictions())
        ...
        # ----------------------------------------------------------------------
    # Additional views for professional traders
    # The dashboard now surfaces key tables from the database when available
    # to give a fuller picture of current risk, positions, and orders.
    # ----------------------------------------------------------------------
    ...
    # Top signals: show the highest conviction predictions (top 20)
    st.divider()
    st.subheader("Top Signals")
    preds_df = view_latest_predictions(100)
