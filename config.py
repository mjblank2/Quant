...
ALPACA_DATA_FEED = os.getenv("ALPACA_DATA_FEED", "sip")  # 'sip' if entitled, fallback to 'iex'
...
SPREAD_BPS = _as_float("SPREAD_BPS", 7.0)           # round-trip spread estimate (bps) for small caps
COMMISSION_BPS = _as_float("COMMISSION_BPS", 0.5)   # explicit commission
...
# v16 optimizer/crowding/tax knobs
...
# Tax
TAX_LOT_METHOD = os.getenv("TAX_LOT_METHOD", "hifo").lower()  # hifo | fifo
...
RUSSELL_INDEX       = os.getenv("RUSSELL_INDEX", "R2000")  # or R3000
