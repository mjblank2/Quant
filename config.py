...
ALPACA_DATA_FEED = os.getenv("ALPACA_DATA_FEED", "sip")  # 'sip' for paid SIP
TIINGO_API_KEY = os.getenv("TIINGO_API_KEY", "")

# HTTP / async
HTTP_TIMEOUT = _as_float("HTTP_TIMEOUT", 20.0)
...
LONG_TOP_N = int(os.getenv("LONG_TOP_N", str(TOP_N)))
SHORT_TOP_N = int(os.getenv("SHORT_TOP_N", str(TOP_N)))
...
DAILY_REBALANCE_COST_BPS = _as_float("DAILY_REBALANCE_COST_BPS", 1.0)
