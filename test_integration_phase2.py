...
def test_imports():
    ...
    try:
        ...
        print(f"✅ Configuration import successful: TimescaleDB={ENABLE_TIMESCALEDB}, Validation={ENABLE_DATA_VALIDATION}")
    ...
    try:
        ...
        expected_columns = {'id', 'run_timestamp', 'validation_type', 'status', 'message', 'metrics', 'affected_symbols'}
        ...
        expected_lineage_columns = {'id', 'table_name', 'symbol', 'data_date', 'ingestion_timestamp', 'source'}
